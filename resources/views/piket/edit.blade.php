                    ...
                    <div class="col-lg-8">
                        <select class="form-control siswa-select2" name="siswa_id" id="siswa">
                            <option disabled selected>Pilih Siswa</option>
                                <option {{ $piket->siswa->nama ? 'selected' : '' }} value="{{ $piket->siswa->id }}">{{ $piket->siswa->nama }}</option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        <select class="form-control" name="hari" id="">
                            ...
                            <option {{ $piket->hari == "Senin" ? 'selected' : '' }} value="Senin">Senin</option>
                            <option {{ $piket->hari == "Selasa" ? 'selected' : '' }} value="Selasa">Selasa</option>
                            <option {{ $piket->hari == "Rabu" ? 'selected' : '' }} value="Rabu">Rabu</option>
                            <option {{ $piket->hari == "Kamis" ? 'selected' : '' }} value="Kamis">Kamis</option>
                            <option {{ $piket->hari == "Jumat" ? 'selected' : '' }} value="Jumat">Jumat</option>
                        </select>
                    </div>
                </div>
